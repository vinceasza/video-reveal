...
var navi = function() {
    var $window = $(window), $sidebar = $(".side-menu"), $header = $("#header");
    return {
        style: function() {
            var sidebarHeight = $window.height() - $header.height();
            console.log(sidebarHeight), $sidebar.css("height", sidebarHeight);
        },
        toggleNav: function() {
            $(".responsive-menu-btn a").on("click", function(e) {
                ...
                if ($this.hasClass("open")) {
                    ...
                    console.log("test"), $this.addClass("open");
                    var pos = 0;
                }
                $sidebar.animate({
                    right: pos + "px"
